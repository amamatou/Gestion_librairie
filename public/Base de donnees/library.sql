...
--
-- Hôte : 127.0.0.1
-- Généré le : ven. 25 fév. 2022 à 02:06
...
(2, '2022-02-13 16:17:14', '2022-02-21 19:00:50', '2022-02-13', '2022-02-13', 0, 1, 2),
...
CREATE TABLE `emprunts` (
  ...
  `etat_exemplaire` enum('bon','moyen','mauvais') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'bon',
  `statut` enum('en cours','depasse','remis') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'en cours',
...
INSERT INTO `emprunts` (`id`, `created_at`, `updated_at`, `dateRetour`, `etat_exemplaire`, `statut`, `exemplaire_id`, `abonne_id`) VALUES
(2, '2022-02-13 19:38:59', '2022-02-24 22:33:37', NULL, 'bon', 'remis', 2, 3),
(3, '2022-02-13 19:39:46', '2022-02-13 19:39:46', NULL, 'bon', 'en cours', 3, 3),
(4, '2022-02-13 19:40:08', '2022-02-13 19:40:08', NULL, 'bon', 'en cours', 5, 4),
(5, '2022-02-13 19:40:34', '2022-02-13 19:40:34', NULL, 'bon', 'en cours', 6, 4),
(6, '2022-02-13 19:41:00', '2022-02-13 19:41:00', NULL, 'bon', 'en cours', 7, 7),
(7, '2022-02-13 19:41:18', '2022-02-13 19:41:18', NULL, 'moyen', 'en cours', 8, 8),
(8, '2022-02-13 19:41:18', '2022-02-13 19:41:18', NULL, 'moyen', 'en cours', 8, 8);
...
ALTER TABLE `emprunts`
  ...
  ADD KEY `emprunts_abonne_id_foreign` (`abonne_id`);
...
--
ALTER TABLE `emprunts`
  ADD CONSTRAINT `emprunts_abonne_id_foreign` FOREIGN KEY (`abonne_id`) REFERENCES `abonnes` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `emprunts_exemplaire_id_foreign` FOREIGN KEY (`exemplaire_id`) REFERENCES `exemplaires` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
