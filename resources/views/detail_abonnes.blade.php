...
<div class="container mt-3">
    ...
    <div class="flex_div_center">
        <a href="#"><button type="button" class="btn_style flex_div_center_item">Payer</button></a> {{-- afficher si value=("Non_payes") --}}
        <a href="#"><button type="button" class="btn_style flex_div_center_item">Modifier</button></a>
